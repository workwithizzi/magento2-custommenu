...
namespace Izzi\CustomMenu\Model;

use Izzi\CustomMenu\Api\MenuLinkManagementInterface;
...
use Izzi\CustomMenu\Model\LinkTypes;
...
class MenuLinkManagement implements MenuLinkManagementInterface
{
    ...
    const  XML_PATH_PRE_CMS_CUSTOM_LINKS = 'custommenu/cms_custom_links';
